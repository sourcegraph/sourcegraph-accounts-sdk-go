...
func TestAllowedGoldenList(t *testing.T) {
	...
	autogold.Expect(AllowedScopes{
		...
		Scope("cody_gateway::workspaces::read"),
		Scope("cody_gateway::workspaces::write"),
		Scope("cody_gateway::workspaces::delete"),
		...
		Scope("sams::user.external_accounts::read"),
		Scope("sams::user.external_accounts::write"),
		Scope("sams::user.external_accounts::delete"),
		...
		Scope("sams::user.metadata.plg::read"),
		Scope("sams::user.metadata.plg::write"),
		Scope("sams::user.metadata.plg::delete"),
		...
		Scope("enterprise_portal::subscription_notifications::read"),
		Scope("enterprise_portal::subscription_notifications::write"),
		Scope("enterprise_portal::subscription_notifications::delete"),
